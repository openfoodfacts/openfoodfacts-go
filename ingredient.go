...
type Ingredient struct {
	...
	PercentEstimate json.Number `json:"percent_estimate,omitempty"`
	PercentMax      json.Number `json:"percent_max,omitempty"`
	PercentMin      json.Number `json:"percent_min,omitempty"`
}
